report 50130 "ALF_Costing_Error_Detection"
{
    // version NAVDIAG17.10.06

    DefaultLayout = RDLC;
    RDLCLayout = './Rep50130.ALF_Costing_Error_Detection.rdlc';
    Caption = 'ALF_Costing_Error_Detection';
    ...
    labels
    {
        ReportName = 'ALF_Costing_Error_Detection';
        PageNoCaption = 'Page';
    }
